function rollWildMagic() {
  const randomResult = Math.floor(Math.random() * 10001);
  document.getElementById('roll_result').innerHTML = "Rolled Result: "+ randomResult.toString();

  if(document.getElementById('modifierCheckBox').checked){
    updateResults(randomResult+parseInt(document.getElementById('inputValid').value.toString()));
  }
  else{
    updateResults(randomResult)
  }
...
function validateManualEntry(){
  if(isManualEntryValid()){
    ...
    if(document.getElementById('modifierCheckBox').checked){
    updateResults(parseInt(document.getElementById('manualInputValid').value.toString())+parseInt(document.getElementById('inputValid').value.toString()));
    }
    else{
      console.log(document.getElementById('manualInputValid').innerHTML.toString());
      updateResults(parseInt(document.getElementById('manualInputValid').value.toString()));
    }
...
function updateResults(rollResult){
  if(rollResult-3>0){
    document.getElementById('roll_res_1').innerHTML = rollResult-3;
    document.getElementById('roll_val_1').innerHTML = wildMagicEffects[rollResult-3];
  }
  else{
    document.getElementById('roll_res_1').innerHTML = "";
    document.getElementById('roll_val_1').innerHTML = "";
  }

  if(rollResult-2>0){
    document.getElementById('roll_res_2').innerHTML = rollResult-2;
    document.getElementById('roll_val_2').innerHTML = wildMagicEffects[rollResult-2];
  }
  else{
    document.getElementById('roll_res_2').innerHTML = "";
    document.getElementById('roll_val_2').innerHTML = "";
  }

  if(rollResult-1>0){
    document.getElementById('roll_res_3').innerHTML = rollResult-1;
    document.getElementById('roll_val_3').innerHTML = wildMagicEffects[rollResult-1];
  }
  else{
    document.getElementById('roll_res_3').innerHTML = "";
    document.getElementById('roll_val_3').innerHTML = "";
  }

  document.getElementById('roll_res_4').innerHTML = rollResult;
  document.getElementById('roll_val_4').innerHTML = wildMagicEffects[rollResult];

  if(rollResult+1<10001){
    document.getElementById('roll_res_5').innerHTML = rollResult+1;
    document.getElementById('roll_val_5').innerHTML = wildMagicEffects[rollResult+1];
  }
  else{
    document.getElementById('roll_res_5').innerHTML = "";
    document.getElementById('roll_val_5').innerHTML = "";
  }

  if(rollResult+2<10001){
    document.getElementById('roll_res_6').innerHTML = rollResult+2;
    document.getElementById('roll_val_6').innerHTML = wildMagicEffects[rollResult+2];
  }
  else{
    document.getElementById('roll_res_6').innerHTML = "";
    document.getElementById('roll_val_6').innerHTML = "";
  }

  if(rollResult+3<10001){
    document.getElementById('roll_res_7').innerHTML = rollResult+3;
    document.getElementById('roll_val_7').innerHTML = wildMagicEffects[rollResult+3];
  }
  else{
    document.getElementById('roll_res_7').innerHTML = "";
    document.getElementById('roll_val_7').innerHTML = "";
  }
}

const wildMagicEffects = [
"1/2 of caster's body furns to stone",
"1/2 of casters body furns to sodium, the other 1/2 turns to ice",
"random magic item within 30 feet of caster explodes",
"random normal item within 30 feet of caster shrinks by 90%",
"metal statuettes appear & fall to the ground near the caster",
"12 foot iron statue of caster sprouts from ground within 60° of him",
"daisy grows from the top caster's head, may be pruned without harm",
"1d10 of casters fingers turn to steel",
"1d10 sparrow eges tumble from casters mouth",
...
"1d6 rounds of booing and hisses echo every time caster speaks his name",
"1d6 rounds of dramatic music play when caster speaks his name",
"1d8-1 bones teleport into caster; loses d12 HP per bone which deisolve within 24 hours",
"1d8-1 bones teleport out of caster; loses d10 HP per bone which regenerate within 24 hours",
"3d10 gazelles appear in the caster's home",
"4d8 of casters teeth turn to gold.",
"a 6 inch diameter hole penetrates casters torso, front to back; caster remains unharmed",
"8d4 of casters teeth become sentient",
"A 1d100x5 foot deep sink-hole opens beneath caster; DEX check or fall",
"A cuckoo pops from caster’ mouth 1d12 times like a clock",
...
"A late-model Ford suddenly appears in casters new driveway", //replace
...
"A red light flashes atop casters head for one turn",
...
"Air Elemental resides in casters lungs; caster no longer needs to breath",
"All air between 5 and 10 feet of caster turns to iron",
"All air between 1 and 10 feet of caster tums to water",
"All air within 20 feet of caster tums to fire (as if fireball spell)",
"All air within 1 foot of caster tums to chlorine gas",
"All allies appear identical to caster for d12 rounds",
"All allies appear identical to target for d4 rounds",
"All architecture within 60 feet of caster is leveled",
"All Bags of Holding within 120 feet of caster dump their contents",
"All but 1 (player choice) of casters attributes rerolled daily",
"All but one of caster's attributes raised to 18 and slowly return to normal, one point per day",
"All but one of casters attributes reduced to 3 and slowly return to normal, one point per day",
"All caster's attribute scores are halved and slowly return to normal, one point per day",
"All caster's attribute scores drop to equal his worst score and slowly return to normal, one point per day",
"All caster's attribute scores rise to equal his best score and slowly return to normal, one point per day",
"All caster's attributes drop to 3 and slowly return to normal, one point per day",
...
"All caster’s equipment furns to platinum of equal weight",
"All caster’s gems become enchanted with Continual Light 20 feet bright 20 feet dim",
"All casters gold pieces tum to teeth",
"All casters precious metal turs to soap",
...
"All cooked meat seen by caster in next 5d20 days tums to liver",
"All creatures viewed by caster look and sound identical for the next 1d20 days",
"All creatures within 100 yards Alter Self to appear as caster",
"All creatures within 100 yards Alter Self to appear as caster",
"All creatures within 100 yards must ignore the caster for 1d4 rounds",
"All creatures within 90 feet of caster have a singalong for 1 turn",
...
"All external facial features of caster disappear via illusion",
...
"All foliage within 30 feet of caster grows 3 feet",
"All food and drink tastes utterly bland to the caster",
"All free water within 120° of caster furns to molasses",
"All gems currently carried by caster are turned to ice",
"All gems currently carried by caster 1d4 fire damage per gem",
"All gold currently carried by caster becomes as hard as steel",
"All gold currently carried by caster increases in weight by 100X",
"All gold currently carried by caster melts at 32° Fahrenheit",
"All gold currently carried by caster tums to fool's gold",
"All gold currently carried by caster tums to lead",
"All gold currently carried by caster turns to platinum",
"All gold pieces currently carried by caster turn to goldfish",
"All ground within 60° of caster is Greased, as spell",
"All ground within 60° of caster turns to glass, 10° deep",
"All items carried by caster affected as by the spell Item",//replace
"All items carried by caster affected as by There/Not There",//replace
"All items carried by caster age 1000 years",
"All stems carried by caster appear in a single pocket", //replace
"All items carried by caster appear in someone else's possession",
"All items carried by caster are now coveted by an outer plane being.",
"All items carried by caster are encased in bone",
"All items carried by caster are enchanted with Explosive Runes",
"All items carried by caster are double in weight for 1 day",
"All items carried by caster become copies of one item he bears",
"All items carried by caster become highly flammable; Save -5", //fix
"All items carried by caster become illusionary (10+d10 rounds)",
"All items carried by caster become resistant to fire; Save +5", //fix
"All items carried by caster become weightless; may float away",
"All items carried by caster double in size",
"All items carried by caster turn to cheese",
...
"All items carried by caster tie into random tiny beasts",
...
"All magic weapons within 30 feet of caster vanish for 1d20 turns",
"All non living matter within 60 feet of caster becomes invisible for 1d4 rounds",
"All meat tastes blood-raw to the caster",
"All metal on or within caster tums to wood",
"All normal fires within 60 feet of caster smell like burning tar",
"All of caster's clothing now bears his monogram",
"All plants and wildlife appear sickly to the caster",
"All normal and magic rings worn by caster tum to string but retain properties",
"All rocks larger than 1 foot within 10 foot of caster explode",
"All rodents within 2 miles will follow caster for d10 days",
"All rope, string, etc. within 120 feet of caster turns to licorice",
"All sorts of vile noises issue from the caster's stomach for 1d20 rounds",
"All spells caster has memorized are cast upon random targets in range of caster without epending spell slots",
"All spells caster has memorized strike him with reversed effect",
"All spells caster now has memorized allow no Saving Throws the next time they are cast",
"All spells caster now has memorized are burned from his memory until next long rest",
"All spells caster now has memorized cause half damage", //fix
"All spells caster now has memorized discharge on him without epending spell slots",
"All spells caster now has memorized discharge on his boots",
"All spells used by caster take place 1d4 rounds afier casting",
"All ten of caster's fingers are now on his dominant hand cannot use two hands oo two handed weapons",
"All the bones disappear from the casters hands and regenerate in 24 hours",
"All trees within 100 yards of caster are turned to cast iron",
"All trees within 30 feet of caster burst into flame",
"All trees within 60 feet of caster uproot and walk away",
"All water between 1 foot and 10 feet of caster tums to fire",
"All water between 1 foot and 100 feet of caster urns to air",
"All water carried by caster boils, increasing volume by 1600X",
"All weapons within 60 feet of caster become ethereal for d8 rounds",
"All weapons within 60 feet of caster turn invisible for 1d4 tums",
...
"All within 10 feet of caster receive benefit of a Heal spell",
"All within 90 feet of caster check INT or forget who the caster is",//fix //replace
"All wood on or within caster tums to metal",
"All writing appears backward to caster",
"All writing in books held by calster turns blurry to caster",
"All writing in caster's spellbook turns invisible to anyone whearing clothes",
"Alternating strips of caster rendered invisible for d8 rounds",
"An illusionary patch labeled 'leper' appears on any clothes the caster dons",
"An illusionary patch labeled 'Wizard' appears on any clothes the caster dons",//inspect
"An illusory Lich rises from the ground and pursues caster for 24 hours",
"An Iron Golem in the caster's image appears & attacks everyone",
"Any ally hearing caster in the next 24 hours must Save or fall asleep with boredom",
...
"Any fires lit by the caster cannot be put out by him",
"Any food prepared by caster is poisonous to him",
"Any glass carried by caster turns to transparent steel",
"Any magic now affecting caster lasts until he wishes to end it.",
...
"Any Wishes thus far used by caster are nullified", //left off here
